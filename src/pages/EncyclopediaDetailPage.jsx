...
function SectionTitle({ children }) {
    return (
        <div className="encyclopedia-detail-titleline">
            <h2>{children}</h2>
            <span className="encyclopedia-detail-titleline-bar" aria-hidden="true" />
        </div>
    );
}
...
function normalizeArticleMarkdown(markdown) {
    ...
    return source
        .replace(/<!--\s*BAROLAB_AUTO_GENERATED\s*-->/gi, '')
        .replace(/\[\[([^\]]+)\]\]/g, (_, raw) => {
...
export default function EncyclopediaDetailPage() {
    ...
    const isAutoGeneratedArticle = useMemo(
        () => /<!--\s*BAROLAB_AUTO_GENERATED\s*-->/i.test(String(detail?.publishedMarkdown || '')),
        [detail?.publishedMarkdown],
    );
            ...
            <div className="container encyclopedia-detail-container">
                ...
                <section className="encyclopedia-detail-hero glass-card">
                    <div className="encyclopedia-detail-hero-main">
                        <h1 className={String(detail.title || '').length > 24 ? 'encyclopedia-detail-heading-long' : ''}>
                            {detail.title}
                        </h1>
                ...
                <div className="encyclopedia-detail-layout">
                    <main className="encyclopedia-detail-main">
                        <section className="encyclopedia-detail-section glass-card">
                            ...
                            {hasArticleMarkdown ? (
                                <article
                                    className={`encyclopedia-article-html${isAutoGeneratedArticle ? ' encyclopedia-article-html-generated' : ''}`}
                                >
                        ...
                        {eventActions && (
                            <section className="encyclopedia-detail-section encyclopedia-detail-data-section glass-card">
                                ...
                                <>
                                    ...
                                    {(hiddenProperties.length > 0 || Boolean(eventActions)) && (
                                        <button
                                            ...
                                            aria-expanded={showRawProperties}
                                            aria-controls="encyclopedia-raw-properties"
                                    ...
                                    {showRawProperties && (
                                        <div
                                            className="encyclopedia-properties-table-wrap"
                                            id="encyclopedia-raw-properties"
                                        >
