...
const RELATION_LABELS = {
    ...
    HOLDS: { OUTGOING: 'Holds', INCOMING: 'Fits into' },
    SHIPPED_IN: { OUTGOING: 'Shipped in', INCOMING: 'Ships' },
    PROTECTS_FROM: { OUTGOING: 'Protects from', INCOMING: 'Protection against it' },
    REQUIRES_REPUTATION: { OUTGOING: 'Requires standing with', INCOMING: 'Restricted goods' },
    REWARDS_REPUTATION: { OUTGOING: 'Rewards reputation with', INCOMING: 'Missions rewarding it' },
    AVAILABLE_AT: { OUTGOING: 'Available at', INCOMING: 'Missions offered here' },
    TRIGGERS_EVENT: { OUTGOING: 'Triggers', INCOMING: 'Triggered by' },
    FOUND_IN: { OUTGOING: 'Found in', INCOMING: 'Resources found here' },
    SPAWNS: { OUTGOING: 'Spawns', INCOMING: 'Spawned by' },
    CARRIES: { OUTGOING: 'Carries', INCOMING: 'Carried by' },
    ARMED_WITH: { OUTGOING: 'Armed with', INCOMING: 'Mounted on' },
    REPAIRED_WITH: { OUTGOING: 'Repaired with', INCOMING: 'Repairs' },
    GRANTS_TALENT: { OUTGOING: 'Grants', INCOMING: 'Granted by' },
